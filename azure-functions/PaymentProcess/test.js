...
function testPaymentRecordCreation() {
    ...
    const expectedPaymentRecord = {
        id: expect.any(String), // Would be generated by Cosmos DB
    ...
    console.log('✅ Payment record creation test passed');
}
...
function testEmailNotification() {
    ...
    const expectedEmailData = {
        ...
        text: expect.stringContaining('Thank you for your booking'),
        html: expect.stringContaining(paymentData.customerName)
    };
...
try {
    ...
    console.log('🎉 All PaymentProcess Function tests passed!');
} catch (error) {
